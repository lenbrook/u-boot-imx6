...
enum {
	...
	MX6_PAD_UART1_TXD__UART1_TXD				= IOMUX_PAD(0x05A4, 0x029C, 0, 0x0000, 0, 0),
        MX6_PAD_ECSPI2_SCLK__UART3_RXD				= IOMUX_PAD(0x0370, 0x0080, 2, 0x080C, 3, 0),
        MX6_PAD_ECSPI2_MOSI__UART3_TXD				= IOMUX_PAD(0x036C, 0x007C, 2, 0x0000, 0, 0),
	MX6_PAD_EPDC_D3__GPIO1_IO10					= IOMUX_PAD(0x03A4, 0x00B4, 5, 0x0000, 0, 0),
